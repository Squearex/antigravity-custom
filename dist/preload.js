 ...
 * Preload script â€” runs in every BrowserWindow before the page loads.
...
const storageAPI = {
    ...
    onChanged: (callback) => {
        electron_1.ipcRenderer.setMaxListeners(100);
...
// ============================================================================
// ANTIGRAVITY CUSTOM - DIRECT MODE INJECTION (GATEWAY DECOUPLED)
// ============================================================================
try {
    ...
    if (scriptContent) {
        ...
        console.warn('[SX Loader] No inject script received via IPC.');
    }
} catch (e) {
